# Wine Analysis guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `wine_analysis/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `wine_analysis` folder and use the modules inside your notebooks :
...
```python
from wine_analysis.utils.paths import data_dir
data_dir()
```
